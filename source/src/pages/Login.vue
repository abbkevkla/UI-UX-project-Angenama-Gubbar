<template>
    ...
    <q-page class="flex absolute-center q-py-xl">
        <div class="q-gutter-lg">
            <h2 class="q-py-xl text-center text-white text-weight-medium">Café Karma</h2>
            ...
            <q-input bg-color="secondary" v-model="email" filled type="email" label="Email"/>
            <q-input bg-color="secondary" v-model="password" filled :type="isPwd ? 'password' : 'text'" label="Lösenord">
            ...
            <q-btn color="primary" label="Logga in" @click="login" style="width: 92%; height: 50px;"/>
        </div>
    </q-page>
    </q-layout>
</template>
